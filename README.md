...
- It's done when the page uses semantic HTML elements. **Complete**

- It's done when the page uses universal, element, and class selectors in CSS. **Complete**

- It's done when the page features at least three colors in the design. **Complete**
...
- It's done when the contact form includes `input` elements for name and email. **Complete**

- It's done when the contact form includes a Send button. **Complete**

- It's done when the image includes a descriptive `alt` attribute. **Complete**
